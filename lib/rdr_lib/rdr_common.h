...
bool     User_EE_CLR_Flash_Flag;    // +
uint8_t  User_EE_CLR_Count;         // +
...
#define USER_BATT_LOW_POWER         (2080)      //低电 2065 * 3.3 /4096 = 1.663 3.32V     即使键盘不开灯，电池满电4.2V
#define USER_BATT_STDOWN_POWER      (1900)      //关机 1865 * 3.3 /4096 = 1.502 3.04V     输入到板子也就只有4.1V左右
...
bool     User_Power_Low;
bool     User_Power_Low_20;
uint16_t User_Power_Low_Timer_10s_Count;
uint16_t User_Power_Low_Timer_3s_Count;
bool     User_Power_Low_20_Flag;
bool     User_Power_Low_10;
uint8_t  User_Power_Low_Count;
uint8_t  es_stdby_pin_state;
bool     User_Key_Batt_Num_Show;
uint8_t  User_Key_Batt_Count;
uint8_t  LED_RF_Play_Point;
...
#define LED_CAP_INDEX           (46)
#define LED_WIN_L_INDEX         (77)

#define LED_WIN_INDEX           (47)
#define LED_MAC_INDEX           (48)

#define LED_T_INDEX             (36)
#define LED_H_INDEX             (52)
...
uint8_t  Mac_Win_Count;
uint8_t  Mac_Win_Pwm;
uint8_t  EE_CLR_Point_Count;

uint16_t Win_Point_5S_Count;
bool     User_Win_Led_On;     // +

uint16_t Mac_Point_5S_Count;
bool     User_Mac_Led_On;     // +
...
void User_Reset_Show(void);
void Led_Win_Point_Show(void);
void Led_Mac_Point_Show(void);
void Led_Charging_Show(void);
void Led_Button_Point_Show(void);
